document.writeln("<style>" +
    ...
    ".fp-ph-circle {width: 160px;height: 160px;top: 20px;left: 20px;position: absolute;background-color: transparent;-webkit-border-radius: 100%;-moz-border-radius: 100%;border-radius: 100%;border: 2px solid #5e3c19;opacity: .5;-webkit-animation: fp-circle-anim 1.2s infinite ease-in-out;-moz-animation: fp-circle-anim 1.2s infinite ease-in-out;-ms-animation: fp-circle-anim 1.2s infinite ease-in-out;-o-animation: fp-circle-anim 1.2s infinite ease-in-out;animation: fp-circle-anim 1.2s infinite ease-in-out;}" +
    ...
    $(".popup_dangkysdt_dangky").on("click", function (e) {
        ...
        return false;
            ...
            if(checkmobile==0){
                ...
                var url = 'http://chuabenhtriohanoi.com/sendmail';
