...
document.writeln(".c_btn_b a{padding-left:25px;display:inline-block;width:256px;height:45px;line-height:45px;background: url(http://chuabenhtriohanoi.com/public/images/chuyende/mobile/popup/1_07.png) no-repeat 25px center #37aeec;border-radius:6px;font-size:15px;color:#fff;margin-top:0;font-weight: bold;text-decoration: none;}");
document.writeln(".c_btn_b a.atop{ padding-left:25px;display:inline-block;margin-top:1%;background: url(http://chuabenhtriohanoi.com/public/images/chuyende/mobile/popup/1_15.png) no-repeat 25px center #efc239;margin-top:20px;}.c_btn_b a:hover{ color:#fff;}.c_btn_b a:visited{ color:#fff;}.c_btn_b a:active {color: #fff;}");
document.writeln(".c_btn_b a.atop1{ padding-left:25px;display:inline-block;margin-top:1%;background: url(http://chuabenhtriohanoi.com/public/images/chuyende/mobile/popup/1_13.png) no-repeat 25px center #f48a4a;margin-top:20px;}.c_btn_b a:hover{ color:#fff;}.c_btn_b a:visited{ color:#fff;}.c_btn_b a:active {color: #fff;}");
...
document.writeln("            <img src=\"http://chuabenhtriohanoi.com/public/images/chuyende/mobile/popup/c_btn.png\" alt=\"\">");
...
document.writeln("                <img src=\"http://chuabenhtriohanoi.com/public/images/chuyende/mobile/popup/c_zj.png\" alt=\"\">");
document.writeln("            </a>");
